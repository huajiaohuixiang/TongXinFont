...
public class LikeFragmentActivity extends BaseActivity {
    private MyLikesBinding mActivityBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mActivityBinding = MyLikesBinding.inflate(getLayoutInflater());
...
//                        goToUser(feed.getAvatar());
    ...
    private void getMyLikeList(int pageNum, int pageSize) {
